    ...
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="max-w-sm w-full animate-fadeInUp">
        ...
        <div className="text-center mb-8">
          ...
          <h2 className="text-2xl font-black">Accede a tu plan</h2>
        ...
        <div className="bg-brand-500/10 border border-brand-500/20 rounded-xl p-4 mb-6 flex items-center gap-3">
          ...
          <div>
            <p className="text-sm font-semibold text-brand-400">¡Tu plan está listo!</p>
            <p className="text-xs text-slate-400">Solo falta crear tu cuenta para acceder</p>
          </div>
        </div>
        ...
        <p className="text-center text-sm text-slate-500 mt-5">
          ¿Ya tienes cuenta?{' '}
          <Link href="/auth/login" className="text-brand-400 hover:underline">Inicia sesión</Link>
        </p>
      </div>
    </div>
  )
