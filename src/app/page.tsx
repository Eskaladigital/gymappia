    ...
    <main className="min-h-screen flex flex-col items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="relative z-10 text-center max-w-xl animate-fadeInUp">
        ...
        <div className="inline-flex items-center gap-3 mb-8">
          <div className="logo-glow w-16 h-16 rounded-2xl bg-brand-500/20 border border-brand-500/30 flex items-center justify-center animate-pulse-green">
        ...
        <div className="grid grid-cols-3 gap-3 mb-10">
          {[
            ...
            <div key={f.label} className="glass rounded-2xl p-4 text-center card-hover animate-fadeInUp" style={{ animationDelay: `${0.1 + i * 0.05}s` }}>
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          <Link href="/start"
            className="btn-primary px-8 py-4 text-black font-black rounded-xl text-sm tracking-wide">
            🚀 Crear mi plan
          </Link>
          <Link href="/auth/login"
            className="px-8 py-4 glass hover:bg-slate-100 dark:hover:bg-white/10 text-slate-900 dark:text-white font-medium rounded-xl transition-all duration-200 text-sm border border-slate-200 dark:border-white/10 hover:scale-[1.02] active:scale-[0.98]">
            Acceder a mi cuenta →
          </Link>
        </div>
      </div>
